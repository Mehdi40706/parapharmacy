...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/login-C_5OgBU9.js")
  },
  {
    name: "auth-me",
    path: "/auth/me",
    component: () => import("./_nuxt/me-C2XjCPTA.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "guest" } },
    component: () => import("./_nuxt/register-CZceysko.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-5ZDIyCoj.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-DpD6uwqz.js"),
  auth: () => import("./_nuxt/auth-Dzk2GUhX.js"),
  guest: () => import("./_nuxt/guest-B5-6seng.js")
};
...
const layouts = {
  admin: defineAsyncComponent(() => import("./_nuxt/admin-DW0-wLpV.js").then((m) => m.default || m)),
  auth: defineAsyncComponent(() => import("./_nuxt/auth-DWtCfkK0.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-BxSB98eu.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-N4hgZ1T7.js"));
