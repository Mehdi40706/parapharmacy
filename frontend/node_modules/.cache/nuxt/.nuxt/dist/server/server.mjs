import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, defineAsyncComponent, Suspense, mergeProps, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/mehdi/Desktop/para/frontend/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/mehdi/Desktop/para/frontend/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/mehdi/Desktop/para/frontend/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/mehdi/Desktop/para/frontend/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu, defuFn } from "C:/Users/mehdi/Desktop/para/frontend/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL } from "C:/Users/mehdi/Desktop/para/frontend/node_modules/ufo/dist/index.mjs";
import { debounce } from "C:/Users/mehdi/Desktop/para/frontend/node_modules/perfect-debounce/dist/index.mjs";
import { hash } from "C:/Users/mehdi/Desktop/para/frontend/node_modules/ohash/dist/index.mjs";
import { isPlainObject } from "@vue/shared";
import { klona } from "C:/Users/mehdi/Desktop/para/frontend/node_modules/klona/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/nouveau-rrHRtOqk.js")
  },
  {
    name: "admin-produits-id-edit",
    path: "/admin/produits/:id()/edit",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/edit-C9FiCiy3.js")
  },
  {
    name: "admin-categories",
    path: "/admin/categories",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-Bey7Anxl.js")
  },
  {
    name: "admin-commandes",
    path: "/admin/commandes",
    meta: { ...__nuxt_page_meta$5 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-BXWkce1L.js")
  },
  {
    name: "admin-ProductForm",
    path: "/admin/ProductForm",
    component: () => import("./_nuxt/ProductForm-C0kIduJs.js")
  },
  {
    name: "admin-produits",
    path: "/admin/produits",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-D5vloPI_.js")
  },
  {
    name: "admin-utilisateurs",
    path: "/admin/utilisateurs",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-CTFlrmoN.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": "guest" } },
    component: () => import("./_nuxt/login-B-prMhiI.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "guest" } },
    component: () => import("./_nuxt/register-CMJydsoW.js")
  },
  {
    name: "checkout-cancel",
    path: "/checkout/cancel",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/cancel-WR85_-MO.js")
  },
  {
    name: "checkout-success",
    path: "/checkout/success",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/success-OnM5VVmb.js")
  },
  {
    name: "commandes-id",
    path: "/commandes/:id()",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/_id_-B2VB4VXQ.js")
  },
  {
    name: "produits-slug",
    path: "/produits/:slug()",
    component: () => import("./_nuxt/_slug_-CxW1LcHc.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "admin" } },
    component: () => import("./_nuxt/index-DdtoJ0Ci.js")
  },
  {
    name: "checkout",
    path: "/checkout",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-BiFhoQ0i.js")
  },
  {
    name: "commandes",
    path: "/commandes",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-DCpVw126.js")
  },
  {
    name: "compte",
    path: "/compte",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-BqD65G-k.js")
  },
  {
    name: "panier",
    path: "/panier",
    component: () => import("./_nuxt/panier-BWDqlk7e.js")
  },
  {
    name: "produits",
    path: "/produits",
    component: () => import("./_nuxt/index-4V9VXpV5.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DFi4v40U.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-C6fOQ3f2.js"),
  auth: () => import("./_nuxt/auth-DI8S-hkq.js"),
  guest: () => import("./_nuxt/guest-BacpluBM.js")
};
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-sAAw0uRQ.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  admin: defineAsyncComponent(() => import("./_nuxt/admin-B5rdy6Hz.js").then((m) => m.default || m)),
  auth: defineAsyncComponent(() => import("./_nuxt/auth-Bw06WGgN.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-lQzEUaLt.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Cg1iHmbM.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DXoy2A9Y.js"));
